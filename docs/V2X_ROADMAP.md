...
- **Ask, don't give up** *(DONE 2026-09-05, CHANGELOG 2.5.1)*: surfaced by
  the corrected clarification grader — on "Fix my code." / "Make it better."
  the model replied "Request was ambiguous. Unable to proceed." Rule 12 now
  shows the finish call with the question in it: ambiguous-1 and -3 went
  1/3 → 5/5, pass^5 gate PASS on the full suite. Still open: "Update the
  file." (0/5) — the model treats "the file" as a real target and edits
  something; needs a different lever than wording.
